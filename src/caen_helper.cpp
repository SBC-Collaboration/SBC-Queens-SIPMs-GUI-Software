...
namespace SBCQueens {
 ...
 //        		freq);
	...
	uint32_t t_to_record_length(CAEN& res, double ns_time) noexcept {
		return static_cast<uint32_t>(ns_time*1e-9*res->GetCommTransferRate());
	}
